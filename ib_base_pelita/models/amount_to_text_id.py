...
def amount_to_text(number, currency):
    ...
    units_desc = curr_to_words(currency) + ' '
...
#    final_result_sen = start_word + units_name + end_word +' '+cents_name
    final_result_sen = units_desc + start_word + " Point " + end_word
    if currency=='idr' or currency=='IDR':
        final_result_sen = units_desc + start_word + " Point " + end_word + ' Rupiah'
...
def curr_to_words(curr="IDR"):
    ...
    if curr=="JPY":
        return "Japanese Yen"
    if curr=="CNY":
        return "Yuan Republik Rakyat Cina"
    if curr=="IDR":
        return ""
