...
class Home(Home):
    ...
    def web_login(self, redirect=None, **kw):
        ...
        if change_background:
            ...
            if current_hour >= 18 and current_hour < 24: #Night
                request.params['background_src'] = param_obj.get_param('login_form_background_night') or ''
            elif current_hour >= 0 and current_hour < 3: #EarlyDays
                request.params['background_src'] = param_obj.get_param('login_form_background_early') or ''
            ...
            elif current_hour >= 7 and current_hour < 12: # Morning
                request.params['background_src'] = param_obj.get_param('login_form_background_day') or ''
            elif current_hour >= 12 and current_hour < 16: # Afternoon
                request.params['background_src'] = param_obj.get_param('login_form_background_afternoon') or ''
            else: # Dusk-sorehari
