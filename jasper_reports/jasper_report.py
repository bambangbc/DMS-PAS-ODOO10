...
class Report:
    def __init__(self, name, cr, uid, ids, data, context):
        ...
        self.output_format = data.get('jasper_output','pdf')#'pdf'
    ...
    def execute(self):
        ...
        if self.data.get('output_format', False) and self.data.get('output_format', data['jasper_output']) != 'pdf':
            self.output_format = self.data.get('output_format', data['jasper_output'])
